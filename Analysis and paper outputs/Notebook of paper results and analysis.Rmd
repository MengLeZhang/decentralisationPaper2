...
2004 / time invariant. First restrict to 2004.
```{r}
unmatch.tab <- 
  ttwa.tab %>% 
  filter(year == '2004')
...
We can automatically try to ger the best match using genetic matching. Then we 
...
We have a total of `match.stats$nn[1, 1]` English and `match.stats$nn[1, 2]` Scottish ttwa. In our final matched sample, we have `match.stats$nn[2, 1]` English TTWAs matched to`match.stats$nn[2, 2]` Scottish ttwas. 
