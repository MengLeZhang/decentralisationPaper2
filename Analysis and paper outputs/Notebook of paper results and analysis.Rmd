...
ttwa.tab <- 
  ...
  mutate(
    cumNoninc_at_20_04 = cumNoninc_at_20[year == '2004'],
    cumNoninc_at_40_04 = cumNoninc_at_40[year == '2004'],
    cumNoninc_at_60_04 = cumNoninc_at_60[year == '2004'],
    cumNoninc_at_80_04 = cumNoninc_at_80[year == '2004']
  ) %>%
  ungroup %>%
...
match.res <- 
  matchit(match.form,
          ...
          data = unmatch.tab %>% 
            filter(ttwa != 'London') %>%
            dplyr::select(ttwa:total.area, di04, cumNoninc_at_20:cumNoninc_at_80),
          method = 'genetic')
...
form2 <- ~ country + cumNoninc_at_20 + cumNoninc_at_40 + cumNoninc_at_60 + cumNoninc_at_80 + di04 ## We omit the I(year - 2004) variable since last 
