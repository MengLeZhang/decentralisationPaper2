...
neat.tab <- 
  ...
  mutate(year = 2007,
         ...
         la = LA.CODE.x,
         ttwa = ttwa11nm,
         pop = Population.aged.16.59..mid.2005..excluding.prisoners.,
         inc.n = INCOME.SCORE * INCOME.SCORE,
         noninc.n = pop - inc.n,
         dist_main = main_dist,
         dist_nearest = nearest_dist,
         crime = RANK.OF.CRIME.AND.DISORDER.SCORE..where.1.is.most.deprived.,
...
neat.tab <- 
  ...
  mutate(year = 2010,
         ...
         inc.n = INCOME.SCORE * Total.population..mid.2008..excluding.prisoners.,
         noninc.n = pop - inc.n,
         dist_main = main_dist,
         dist_nearest = nearest_dist,
...
neat.tab <- 
  ...
  mutate(year = 2015,
         ...
         inc.n = Income.Score..rate. * Total.population..mid.2012..excluding.prisoners..x %>% as.numeric,
         noninc.n = pop - inc.n,
         dist_main = main_dist,
         dist_nearest = nearest_dist,
